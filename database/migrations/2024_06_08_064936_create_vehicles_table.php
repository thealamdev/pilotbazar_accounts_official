...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('vehicles', function (Blueprint $table) {
            ...
            $table->double('media_purchase_cost')->nullable();
            $table->double('media_selling_cost')->nullable();
            ...
            $table->foreignId('updated_by')->constrained('users')->onUpdate('cascade')->onDelete('cascade')->name('updated_by_fk');
            $table->softDeletes();
            $table->timestamps();
        });
    }

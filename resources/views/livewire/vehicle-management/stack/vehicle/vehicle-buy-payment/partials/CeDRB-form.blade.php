@if ($currentFormType === 'RTGS' || $currentFormType === 'Check Deposit' || $currentFormType === 'Bank Pay Order')
    <form action="#" wire:submit="saveCeDRB" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <label for="form.credit_bank_name">Credit Bank Name<span class="text-danger">*</span></label>
                <div class="input-group mb-3">
                    <span class="input-group-text">৳</span>
                    <input type="text" wire:model.live="form.credit_bank_name" class="form-control @error('form.credit_bank_name') {{ 'is-invalid' }} @enderror" placeholder="credit bank name">
            ...
            <div class="col-lg-6">
                <label for="form.credit_bank_account_number">Credit Bank Account Number<span class="text-danger">*</span></label>
                <div class="input-group mb-3">
                    <span class="input-group-text">৳</span>

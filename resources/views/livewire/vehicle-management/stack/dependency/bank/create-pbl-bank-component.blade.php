<div class="pt-7">
    ...
    <header class="pb-4 d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ route('admin.version1.vehicle-management.vehicle.dependency.bank.pbl_bank.create') }}" class="bg-transparent border border-slate-400 px-4 py-1 rounded" type="button">Payment Methods</a>
        </div>
    </header>
    <!-- Header Part End !-->

<div class="pt-7">
    ...
    <header class="pb-4 d-flex justify-content-between align-items-center">
        <div class="">
            <p class="fs-5 fw-600">Payment Method Update</p>
            <span>Please must fill the field where (*) sign is visible.</span>
        </div>
        <div>
            <a href="{{ route('admin.version1.vehicle-management.vehicle.dependency.payment.method.index') }}"
                class="bg-transparent border border-slate-400 px-4 py-1 rounded" type="button">Payment Methods</a>
        </div>
    </header>
    <!-- Header Part End !-->
    ...
    <div class="border border-slate-400 rounded p-3">
        <form action="#" wire:submit="update" method="POST" wire:key="color_update_component">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <label for="form.name">Payment Methods <span class="text-danger">*</span></label>

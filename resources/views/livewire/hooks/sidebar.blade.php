         ...
         <div data-simplebar class="nicescroll-bar">
             <div class="menu-content-wrap">
                 ...
                 <div class="menu-group">
                     ...
                     <div class="menu-group">
                         <ul class="navbar-nav flex-column">
                             <li class="nav-item {{ Route::is('admin.version1.investor-management.investors.*') ? 'active' : '' }}">
                                 <a class="nav-link" href="{{ route('admin.version1.investor-management.investors.create') }}">
                                     <span class="nav-icon-wrap">
                                         <span class="svg-icon">

             ...
             <div class="content-detail-wrap">
                 <header class="content-header">
                     ...
                     <div class="content-options-wrap">
                         <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover ms-0 d-xl-inline-block d-none" href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Add New">
                             <span class="icon">
                             ...
                             <div class="card card-border mb-0 h-100">
                                 <div class="card-header card-header-action">
                                     ...
                                     <div class="card-action-wrap">
                                         <a href="{{ route('admin.investor.create') }}" class="btn btn-sm btn-primary ms-3">
                                             <span>
                                                 <span class="icon">
                                                     <span class="feather-icon">
